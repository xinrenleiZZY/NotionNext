    ...
    <>
      ...
      >
        ...
        <div className='relative w-full h-full flex items-center justify-center'>
          <span className='text-[10px] font-bold font-mono group-hover:hidden text-[var(--endspace-text-muted)]'>
            {Math.round(progress)}%
          </span>
          <ListCheck2Icon
            size={20}
      ...
      >
        ...
        <div className='flex items-center justify-between px-5 py-4 border-b border-[var(--endspace-border-base)] bg-[var(--endspace-bg-secondary)]'>
          <div className='flex items-center gap-3'>
            ...
            />
            <span className='text-sm font-mono font-bold text-[var(--endspace-text-primary)] uppercase'>
              TOC INDEX
            </span>
            <span className='text-xs font-mono text-[var(--endspace-text-muted)]'>
              {toc.length} sections
            </span>
          </div>
          <button
            onClick={() => setIsOpen(false)}
            className='w-8 h-8 flex items-center justify-center text-[var(--endspace-text-muted)] hover:text-[var(--endspace-accent-yellow)] transition-colors'
          >
              ...
              return (
                <button
                  ...
                  className={`w-full text-left py-3 px-4 text-sm transition-all duration-200 border-l-2 ${
                    isActive
                      ? 'border-[var(--endspace-accent-yellow)] text-[var(--endspace-accent-yellow)] font-bold bg-[var(--endspace-accent-yellow-dim)]'
                      : 'border-transparent text-[var(--endspace-text-secondary)] hover:text-[var(--endspace-accent-yellow)] hover:bg-[var(--endspace-accent-yellow-dim)]'
                  }`}
                  style={{
