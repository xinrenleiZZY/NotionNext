  ...
  return (
    ...
    >
      <form onSubmit={handleSearch} className='space-y-4'>
        {/* Search Label */}
        <div className='flex items-center gap-2 text-[var(--endspace-text-primary)] tech-text tracking-wider'>
        ...
        <div className='relative group'>
          <input
            ...
            className='w-full px-4 py-3 bg-[var(--endspace-bg-secondary)] border border-[var(--endspace-border-base)] text-[var(--endspace-text-primary)] focus:bg-[var(--endspace-text-primary)] focus:text-[var(--endspace-accent-yellow)] focus:border-[var(--endspace-accent-yellow)] focus:outline-none transition-colors pr-24 tech-text text-sm placeholder-[var(--endspace-text-muted)]'
          />
