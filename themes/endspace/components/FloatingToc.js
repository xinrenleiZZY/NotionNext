        ...
        <button
          ...
          className={`flex items-center justify-center transition-all duration-300 shadow-md cursor-pointer border hover:-translate-y-1 hover:shadow-lg relative group rounded-full ${
            isExpanded
              ...
              : 'w-10 h-10 bg-[var(--endspace-bg-secondary)] text-[var(--endspace-text-muted)] border-[var(--endspace-border-base)] hover:bg-[var(--endspace-accent-yellow)] hover:text-black hover:border-[var(--endspace-accent-yellow)]'
          }`}
        ...
        {isExpanded && (
          <div className='p-4'>
            <div className='flex items-center justify-between mb-4'>
              ...
              <div className='w-16 h-1 bg-[var(--endspace-accent-yellow-dim)] rounded-full overflow-hidden'>
                <div
